...
5.	(12 pts) First, re-read the nested loop section on pages 160-161, and read the text and code on pages 208-211. Next, go to this URL and save the program called x <b>stars.cpp</b>: [http://cs.ucsb.edu/~zmatni/cs16s17/hwk/stars.cpp](http://cs.ucsb.edu/~zmatni/cs16s17/hwk/stars.cpp)
  <div style="margin-bottom:1em"></div>
