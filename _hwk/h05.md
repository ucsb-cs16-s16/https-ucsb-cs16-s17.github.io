...
2.	(4 pts) Use precedence rules to re-write the following expressions:
...
3.	(4 pts) What is the output of the following statement?
  <div markdown="1">
```
int p = 5;
while (--p > 0)
...
4.	(4 pts) What is the output of the following statement?
  <div markdown="1">
```
int s = 1;
do
