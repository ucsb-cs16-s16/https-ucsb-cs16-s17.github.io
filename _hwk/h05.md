...
1. (4 pts) What is a run-time error?
	<div style="margin-bottom:6em"></div>

2. (6 pts) You are writing a program that keeps track of a bank account for your customers. 
...
3. (10 pts) Find 5 mistakes in this C++ code, mark them (circle them, put an arrow, etc...), and label each as "logic" or "syntax" error:
	<div markdown="1">
```cpp
#include <iostream>;
use namespace std;
