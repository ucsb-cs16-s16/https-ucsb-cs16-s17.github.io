...
<ol markdown="1">
xxSome of these problems are easier to think about and solve if you try them out in an actual C++ program. You are encouraged to do so - although it is, strictly speaking, not a requirement to solve these problems. Please follow the directions carefully, as grading will be based on what these directions are.
