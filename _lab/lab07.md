...
num: lab07
ready: true
desc: "Arrays and Multiple Compilations"
assigned: 2017-05-24 08:00:00.00-7
due: 2017-05-30 12:00:00.00-7
---
<div markdown="1">
...
<http://www.cs.ucsb.edu/~zmatni/cs16s17/lab07/code>

You should see a listing of several C++ programs. We are going to copy those into your ~/cs16/lab07 directory all at once with the following command:

`cp ~zmatni/public_html/cs16s17/lab07/code/* ~/cs16/lab07`

Note: If you get the error message:
`cp: target /cs/student/youruserid/cs16/lab07 is not a directory`

then it probably means you did not create a ~/cs16/lab07 directory in step 1, so go back to step 1 and do that first.
The * symbol in this command is a "wildcard" — it means that we want <b>all</b> of the files from the source directory copy be copied into the destination directory namely ~/cs16/lab07.

After doing this command, if you cd into ~/cs16/lab07 and use the ls command, you should see several files in your ~/cs16/lab07 directory—the same ones that you see if you visit the link http://www.cs.ucsb.edu/~zmatni/cs16s17/lab07/code
...
In your ~/cs16/lab07 directory, type <b>ls</b> and make note of the different files therein: some are .cpp types, some are .o (short for "object file"), some are .h (short for "header file"), and others do not have extensions (they are binary executables). Now, type <b>make clean</b>. This command cleans out any .o files and executables from your directory
